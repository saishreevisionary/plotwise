...
import { Box, RotateCcw, Home, Eye, Camera, Sun, Moon, Sparkles } from 'lucide-react';
...
const CameraController: React.FC<{
  ...
  presetAngle: 'top' | 'iso' | 'street' | null;
...
export const ThreeDLayoutViewer: React.FC<ThreeDLayoutViewerProps> = ({
  ...
  const [presetAngle, setPresetAngle] = useState<'top' | 'iso' | 'street' | null>('iso');
